...
<div class="well">
	<form class="form-horizontal" action="{{ URL::to('admin/users/edit') }}/{{ $user->id }}" method="post">
        {{ Form::token() }}
...
<div class="well">
	<form class="form-horizontal" action="{{ URL::to('admin/users/changepassword') }}/{{ $user->id }}" method="post">
        {{ Form::token() }}
...
<div class="well">
    <form class="form-horizontal" action="{{ URL::to('admin/users/updatememberships') }}/{{ $user->id }}" method="post">
        {{ Form::token() }}
